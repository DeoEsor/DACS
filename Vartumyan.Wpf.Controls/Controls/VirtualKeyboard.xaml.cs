...
// <date>2011-8-15</date>
// <project>Hurst.VirtualKeyboard</project>
...
using Hurst.VirtualKeyboard.HelpFiles;
using Hurst.VirtualKeyboard.ViewModels;


namespace Hurst.VirtualKeyboard
{
    ...
    public partial class VirtualKeyboard : Window
    {
        ...
        private void OnPreviewKeyDown(object sender, KeyEventArgs e)
        {
            ...
            if ((modifierKeys & ModifierKeys.Shift) != 0 || _viewModel.IsCapsLock)
            //CBL  This version is both slower, and is unavailable in .NET 3.5
        ...
        /// </summary>
        /// <param name="targetWindow">The window that will accept input from the keyboard</param>
        ...
        /// </summary>
        public static IList<string> AvailableKeyboardLayouts
        {
            get
            {
                return KeyboardViewModel.AvailableKeyboardLayouts;
            }
        }
        #endregion
